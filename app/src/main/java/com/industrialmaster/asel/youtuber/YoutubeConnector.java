	...
	public class YoutubeConnector {
        ...
        public List<VideoItem> searchOne(String keywords) {

            //setting keyword to query
            query.setQ(keywords);

            //max results that should be returned
            query.setMaxResults(SMALLMAX);
